...
export function ContentPreview({ title, imageUrl, compact = false }: ContentPreviewProps) {
  ...
  return (
    <div
      className={`shrink-0 overflow-hidden rounded-lg border border-tech-border bg-tech-bg ${
        compact
          ? 'relative h-12 w-20'
    ...
    >
      ...
      >
        <p
          className={`line-clamp-2 font-semibold leading-tight ${showImage ? 'text-white' : 'text-tech-muted'} ${
